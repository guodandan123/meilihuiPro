...
import { Indicator } from 'mint-ui';
	export default {
		...
		mounted(){
			...
			axios.get(`/appapi/home/mktBannerApp/v3?silo_id=2013000100000000003&platform_code=PLATEFORM_H5`).then(res=>{
				// console.log(res.data.banners)
				this.datalist = res.data.banners
				// this.datalist = res.data.data
			})
			axios.get(`/appapi/cms/cmsDetail/v3?silo=2013000100000000003&ids=2042000100000000431&timestamp=1542850025897&summary=c5698c9b305108cb9737de21112a28c6&platform_code=H5`).then(res=>{
			...
			Promise.all([axios.get(`/appapi/home/mktBannerApp/v3?silo_id=2013000100000000003&platform_code=PLATEFORM_H5`),axios.get(`/appapi/cms/cmsDetail/v3?silo=2013000100000000003&ids=2042000100000000431&timestamp=1542850025897&summary=c5698c9b305108cb9737de21112a28c6&platform_code=H5`),axios.get(`/appapi/silo/eventForH5?categoryId=crossborder&pageIndex=1&timestamp=1542941690663&summary=b596ecfc5e46f2814e7a3c0efb098500&platform_code=H5`)]).then(res=>{
					Indicator.close();
					console.log('数据加载完成')
				})
		}
